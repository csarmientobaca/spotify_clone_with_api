...
const Music = ({ sno, track, setGlobalCurrentSongId, setGlobalIsTrackPlaying, setView, setGlobalArtistId }) => {
                    ...
                    <p className='w-36 truncate'>
                        {
                            track.artists.map((artist, i) => {
                                return (
                                    <>
                                        <span onClick={() =>
                                            selectArtist(artist)} className='hover:underline'>{artist.name}</span>
